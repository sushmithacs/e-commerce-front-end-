...
<form data-toggle="validator" role="form" action="home.jsp">
  ...
  <div class="form-group has-feedback">
   <div style="margin-bottom: 25px" class="input-group">
      ...
      <input type="text" pattern="^[_A-z0-9]{1,}$" maxlength="15" class="form-control" id="inputTwitter" placeholder="any name" required>
    </div>
  ...
  <div class="form-group">
   ...
   <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
        ...
        <input type="password" data-minlength="6" class="form-control" id="inputPassword" placeholder="Password(min of 6 chars)" required>
